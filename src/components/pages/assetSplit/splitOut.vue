<template>
  <div style="margin: 3px;">
    ...
    <!-- 产品信息 -->
    <el-table :data="prodTableData" height="30%" border style="width: 100%;">
    ...
    <!-- 资产信息 -->
    <el-table :data="assetTableData" height="50%" border :stripe="true" style="width: 100%;">
      <el-table-column type="selection" align="center" width="40"></el-table-column>
      <el-table-column type="index" align="center" label="序号" width="50"></el-table-column>
      <el-table-column prop="splitRule" show-overflow-tooltip label="分配规则" width="150"></el-table-column>
